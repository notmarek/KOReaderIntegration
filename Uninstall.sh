#!/bin/sh
echo "Removing binaries from /mnt/us/EPUBIntegration"
rm -rf /mnt/us/EPUBIntegration
...
sqlite3 /var/local/appreg.db "DELETE FROM extenstions WHERE ext = 'epub' or ext = 'fb2';"
sqlite3 /var/local/appreg.db "DELETE FROM mimetypes WHERE ext = 'epub' or ext = 'fb2';"
